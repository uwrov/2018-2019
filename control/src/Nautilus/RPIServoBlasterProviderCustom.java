 ...
 */
public class RPIServoBlasterProviderCustom implements ServoProvider {
    ...
    protected Map<Pin, RPIServoBlasterDriverCustom> allocatedDrivers = new HashMap<>();
     ...
     */
    public RPIServoBlasterProviderCustom() throws IOException {
    ...
    /**
     * Returns new instance of {@link RPIServoBlasterDriverCustom}.
     *
     * @param servoPin servo pin.
     * @return instance of {@link RPIServoBlasterDriverCustom}.
     */
    @Override
    public synchronized ServoDriver getServoDriver(Pin servoPin) throws IOException {
        ...
        RPIServoBlasterDriverCustom driver = allocatedDrivers.get(servoPin);
        if (driver == null) {
            driver = new RPIServoBlasterDriverCustom(servoPin, index, PIN_MAP.get(servoPin), this);
