...
public class RPIServoBlasterDriverCustom implements ServoDriver {

    protected Pin servoPin;
    protected int index;
    protected String pinString;
    protected int servoPosition;
    protected RPIServoBlasterProviderCustom provider;

    protected RPIServoBlasterDriverCustom(Pin servoPin, int index, String pinString, RPIServoBlasterProviderCustom provider) throws IOException {
        this.index = index;
