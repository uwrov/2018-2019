...
def alignImages(align, ref):
    ...
    img2_gray = cv2.cvtColor(ref, cv2.COLOR_BGR2GRAY)  # IMAGE TO ALIGN
...
# /home/margot/Documents/uwrov/2018-2019-master/imagerecognition/images
img3 = cv2.cvtColor(cv2.imread("/home/margot/Documents/uwrov/2018-2019-master/imagerecognition/images/identifytest_ref_white.png"), cv2.COLOR_BGR2GRAY)
...
# Use this to test the new input
classify_change_types(img1_w, img1_p, img2_w, img2_p)
# Use this to test using sample input
