...
# TODO: Find height of rov based on line distance - suggest elevation accordingly
# TODO: Identify where in the screen the blue lines are - suggest strafing accordingly

def main():
    # Grab video feed from source
    cap = cv2.VideoCapture('http://10.19.40.99:8080/video/mjpeg')
